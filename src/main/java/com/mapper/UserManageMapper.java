...
public interface UserManageMapper extends SqlMapper
{
    ...
    public void removeUserManages(String userids);
    
    public void editUserManageUpdateTime(@Param("username")String username);
    
    public String checkUsernameIsExist(@Param("username")String username, @Param("userid")String userid);
    
    public UserManage getUserByUserId(@Param("userid")String userid);
}
